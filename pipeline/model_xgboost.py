...
class PMModelTrainer:
    ...
    def train_model(self):
        ...
        logging.info("Starting GridSearchCV for PM2.5 using XGBoost...")
        ...
        joblib.dump(best_model, os.path.join(self.model_dir, 'xgb_model_pm2.5.pkl'))
...
if __name__ == '__main__':
    trainer = PMModelTrainer(
        ...
        model_dir='models/xgboost_pm25_1'
    )
    trainer.execute()
